...
export const APPS: AppRecord[] = [
  {
    ...
    status: 'shipped',
    github: 'https://github.com/jtysonwilliams/Free-Workout-Timer',
    glyph: '◷',
    permissions: 'None',
    network: 'None',
    license: 'MIT',
  ...
  },
  {
    ...
    platforms: ['chrome'],
    status: 'shipped',
    github: 'https://github.com/jtysonwilliams/Ask-AI',
    glyph: '?',
  ...
  },
  {
    ...
    platforms: ['chrome'],
    status: 'shipped',
    github: 'https://github.com/jtysonwilliams/Private-AI-Summary',
    glyph: '≡',
    permissions: 'Active tab',
    network: 'None',
    license: 'MIT',
